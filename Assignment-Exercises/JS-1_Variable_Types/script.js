...
// Using let
let name = "Emily"; // Define a string here, e.g., "Juan Cruz"
let age = 21; // Define a number here, e.g., 30
let isStudent = true; // Define a boolean here, e.g., true or false
let hobbies = "singing"; // Define an array here, e.g., ["reading", "gaming", "coding"]
...
const favoriteBooks = ["The Alchemy", "He's Into Her"]; // Define an array here, e.g., ["1984", "Brave New World", "Fahrenheit 451"]
...
var temperature = 26.4; // Define a number here, e.g., 22.5
var hasPets = false; // Define a boolean here, e.g., true or false
var colors = ["red", "blue", "black"]; // Define an array here, e.g., ["red", "green", "blue"]
